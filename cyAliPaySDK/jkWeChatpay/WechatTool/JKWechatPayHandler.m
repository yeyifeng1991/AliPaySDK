...
@implementation JKWechatPayHandler
...
+ (void)jumpToWxPay
{
    ...
    //获取SIGN签名
    JKWechatSignAdaptor *adaptor = [[JKWechatSignAdaptor alloc] initWithWechatAppId:MXWechatAPPID
    ...
    [session POST:kUrlWechatPay parameters:string success:^(NSURLSessionDataTask * _Nonnull task, id  _Nonnull responseObject) {
        ...
        if ([[dic objectForKey:@"result_code"] isEqualToString:@"SUCCESS"]
            ...
            // 签名加密
            JKWechatSignAdaptor *md5 = [[JKWechatSignAdaptor alloc] init];

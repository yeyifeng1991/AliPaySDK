...
{	
    ...
    {
        NSArray *array11 = [NSArray arrayWithArray:node];
        
        NSMutableArray *nodes = [NSMutableArray arrayWithCapacity:array11.count];
	...
	if (!top.attributes && !top.childNodes && !top.comments)
    {
        ...
        if (nodeName)
        {
            ...
            if (top.innerText && _collapseTextNodes)
            {
                ...
                {
                    NSArray *array22 = [NSArray arrayWithArray:parentNode];
                    parentNode[array22.count - 1] = top.innerText;
                }
                else
                {
...
- (NSString *)stringValueForKeyPath:(NSString *)keyPath
{
    ...
    {
        NSArray *array44 = [NSArray arrayWithArray:value];
        value = array44.count ? value[0]: nil;
    }
...
- (NSDictionary *)dictionaryValueForKeyPath:(NSString *)keyPath
{
    ...
    if ([value isKindOfClass:[NSArray class]])
    {   NSArray *array33 = [NSArray arrayWithArray:value];
        value = array33.count ? value[0]: nil;
    }
